...
\section{Global illumination}
	...
	\begin{center}
		...
		\end{align*}
	\end{center}
	The most popular method for approximating this improper integral is monte-carlo pathtracing\cite{P2PATH}. Radiosity can achieve the same but only for perfectly diffuse surfaces.
