...
\section{Geometry-buffer (g-buffer)}
	...
	\subsection{Computing local illumination using g-buffers (deferred shading)}
		...
		%TODO adjust your explanation by introducing deferred shading (just mention g-buffers in your description)
...
submit geometry with:
  ...
  pixelShader(x, y, z):
	...
	\subsubsection{Reflections}
		%TODO explain how deep-gbuffers do mirror reflections
