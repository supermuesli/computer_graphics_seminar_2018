...
\section{Traditional rendering (rasterization)}
	...
	\subsection{Deferred rendering}
		...
		\end{center}%
		\caption{A scene that was rendered using deferred lighting. The objects are locally illuminated by point-lights using g-buffers.}%
	...
	\subsection{Geometry-buffer (G-buffer)}
		...
		\subsubsection{Albedo-buffer}%
			...
			\begin{figure}[htb!]%
				\begin{center}%
					\includegraphics[width=7cm]{img/wiki_frame_buffer.png}
				\end{center}%
				\caption{Example of an albedo-buffer. It shows a scene containing a torus, a sphere, a cuboid and a cone, all standing on a plane.}%
		...
		\subsubsection{Z-buffer}
			...
			\begin{figure}[htb!]%
				\begin{center}%
					\includegraphics[width=7cm]{img/wiki_z_buffer.png}
				\end{center}%
				\caption{Example of a z-buffer. The lighter a pixel, the further away it is from the cameras point of view.}%
				\label{fig:z_buffer}
			\end{figure}%
		\subsubsection{Normal-buffer}
			...
			\begin{figure}[htb!]%
				\begin{center}%
					\includegraphics[width=7cm]{img/wiki_normal_buffer.png}
				\end{center}%
				\caption{Example of a normal-buffer. The x, y and z components of a normal-vector correspond to an RGB color.}%
